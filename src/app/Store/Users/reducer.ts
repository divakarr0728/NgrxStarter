...
import { addCUSTOMERsuccess, deleteCUSTOMERsuccess, getCUSTOMERsuccess, loadCUSTOMERfail, loadCUSTOMERsuccess, OPEN_POPUP_CUSTOMER, openpopupcustomer, updateCUSTOMERsuccess } from "./action";
import { CustomerState, customerAdopter } from "./state";
