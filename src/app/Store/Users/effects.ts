...
import { addCUSTOMER, addCUSTOMERsuccess, deleteCUSTOMERsuccess, deleteeCUSTOMER, getCUSTOMER, getCUSTOMERsuccess, loadCUSTOMER, loadCUSTOMERfail, loadCUSTOMERsuccess, updateCUSTOMER, updateCUSTOMERsuccess } from "./action";
